...
<table id="list_tags" class="table table-striped table-bordered table-hover" cellspacing="0" style="width:100%">
	...
	<tr>
		...
		<th data-source="tag_picture" data-filter data-render="showLogo">Picture</th>
        <th data-source="tag_name" data-filter>Name</th>
...
<script>
	...
	function toolbar(data, type, row, meta)
	{
		...
		// toolButtons += '<i id="toolButtons_filter" data-backdrop="static" class="material-icons" title="Related Members">group</i>';
