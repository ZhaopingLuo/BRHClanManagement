...
class Organizations extends CI_Controller {
	...
	public function ajax_create()
	{
        ...
        $organization_fullname 	= $this->input->post('organization_fullname');
        $organization_prefix 	= $this->input->post('organization_prefix');

		$data = array(
			'organization_id'		  => $organization_id,
            'organization_name'		  => $organization_name,
            'organization_fullname'		  => $organization_fullname,
	...
	public function ajax_update()
	{
		...
		if ($validation_result["success"] === TRUE)
		{
			...
			{
				$config['height']   	 =  $upload_data["image_height"] > 55? 55: $upload_data["image_height"];
